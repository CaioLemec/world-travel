...
export function Banner() {
  return (
    <Flex backgroundImage="/images/bannerBg.png" align="center" justify="center" w="100%" minH={335} maxW={1440} m="auto">
      ...
      <Box position="relative" w="100%" h="100%" justifyContent="center" alignItems="center" display="flex" flexDirection="column">
        <Image position="absolute" top={-25} maxWidth={375} src="/images/Airplane.svg" alt="Airplane" />
      </Box>
    </Flex>
  );
}
